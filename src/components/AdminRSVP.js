  ...
  return (
    ...
    >
      ...
      <Row className="mb-3">
        ...
        <Col md={6}>
          <Form.Select value={attendFilter} onChange={(e) => setAttendFilter(e.target.value)}>
            <option value="">Бүх оролцогчид</option>
            <option value="no">Ирэхгүй</option>
            <option value="ceremony">Зөвхөн ёслол</option>
            <option value="party">Зөвхөн цайллага</option>
            <option value="both">2ууланд нь</option>
          </Form.Select>
        </Col>
      </Row>
